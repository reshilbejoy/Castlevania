...
grid = Grid()
enemy = Enemy(40, window_length, window_height, player.isBgMoving, movement_speed, window_height + score_box - int(630 / 5))
#print(grid.grid_return())
platform = Platform(100, 30, window_length / 2, (window_height) - 230)
new_platform = Platform(100, 30, window_length / 1.3, (window_height) - 160)
...
platforms = [platform, ground, new_platform]
...
def game():
    ...
    while not game_over:
        ...
        viewpoint_x, enemy.enemy_x, enemy.enemy_y = player.move(pressed, enemy.enemy_x, enemy.enemy_y, platforms)
